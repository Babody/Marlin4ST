...
#define CONDITIONALS_POST_H
  ...
  const float MIN_PROBE_X = (max(X_MIN_POS, X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER));
  const float MAX_PROBE_X = (min(X_MAX_POS, X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER));
  const float MIN_PROBE_Y = (max(Y_MIN_POS, Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER));
  const float MAX_PROBE_Y = (min(Y_MAX_POS, Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER));
